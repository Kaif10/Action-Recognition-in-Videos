...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="data/UCF101/UCF-101-frames/UCF101/UCF-101", help="Path to UCF-101 dataset")
    ...
    for epoch in range(opt.num_epochs):
        ...
        for batch_i, batch in enumerate(train_dataloader):
            ...
            X, y = batch
            # Skip batches with only one element to prevent LSTM hidden state errors
            if X.size(0) == 1:
                continue
